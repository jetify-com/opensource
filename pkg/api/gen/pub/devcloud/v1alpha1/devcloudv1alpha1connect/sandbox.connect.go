...
import (
	...
	context "context"
	errors "errors"
	v1alpha1 "go.jetpack.io/pkg/api/gen/pub/devcloud/v1alpha1"
	http "net/http"
	strings "strings"
)
...
func (UnimplementedSandboxServiceHandler) DeleteSandbox(context.Context, *connect.Request[v1alpha1.DeleteSandboxRequest]) (*connect.Response[v1alpha1.DeleteSandboxResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pub.devcloud.v1alpha1.SandboxService.DeleteSandbox is not implemented"))
}
...
func (UnimplementedSandboxServiceHandler) ListSandboxes(context.Context, *connect.Request[v1alpha1.ListSandboxesRequest]) (*connect.Response[v1alpha1.ListSandboxesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pub.devcloud.v1alpha1.SandboxService.ListSandboxes is not implemented"))
}
